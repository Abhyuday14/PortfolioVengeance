          ...
          <div>
            ...
            <div className="border-l border-rain-grey pl-6">
              ...
              <div className="flex flex-wrap gap-6">
                ...
                {/* LinkedIn */}
                <a href="https://www.linkedin.com/in/abhyuday-sachdeva-975594230" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-2 text-light-text hover:text-blood-red transition-colors">
                ...
                {/* Instagram */}
                <a href="https://www.instagram.com/abhyuday1164?igsh=MTZ4OHRxZXYxdmZ3Ng==" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-2 text-light-text hover:text-blood-red transition-colors">
